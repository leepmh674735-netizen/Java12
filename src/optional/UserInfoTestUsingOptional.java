...
public class UserInfoTestUsingOptional {
    public static void main(String[] args) {
        ...
        userInfoList.add(new UserInfo(67890, "Tomas"));
        userInfoList.add(new UserInfo(54321, "Edward"));
    
        usingOptional(userInfoList);
    }
    
    public static void usingOptional(ArrayList<UserInfo> list) {
        Optional<UserInfo> userInfoOptional = getUseInfoByOptional(12345, list);
        ...
        UserInfo nameOrDefault = userInfoOptional.orElse(new UserInfo(0, "Guest"));
    ...
    public static Optional<UserInfo> getUseInfoByOptional(int id, ArrayList<UserInfo> list) {
